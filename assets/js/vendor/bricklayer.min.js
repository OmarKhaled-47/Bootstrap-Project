...
!(function (e) {
  if ("function" != typeof e) throw new Error("Bricklayer is not initialized.");
  (e.prototype.addLazyElement = function (e, n) {
    var t = this;
    return n(function (n) {
      t["prepend" === e ? e : "append"](n);
    });
  }),
    (e.prototype.appendLazyElement = function (e) {
      return this.addLazyElement("append", e);
    }),
    (e.prototype.prependLazyElement = function (e) {
      return this.addLazyElement("prepend", e);
    });
})(Bricklayer);
document.querySelectorAll(".bricklayer").forEach(function (e) {
  new Bricklayer(e);
});
